...
var _user$project$Models$Model = F3(
	function (a, b, c) {
		return {time: a, target: b, clockMode: c};
	});
var _user$project$Models$None = {ctor: 'None'};
var _user$project$Models$SecondHand = {ctor: 'SecondHand'};
var _user$project$Models$MinuteHand = {ctor: 'MinuteHand'};
var _user$project$Models$HourHand = {ctor: 'HourHand'};
var _user$project$Models$Stop = {ctor: 'Stop'};
var _user$project$Models$Start = {ctor: 'Start'};
var _user$project$Models$initialModel = {time: 0.0, target: _user$project$Models$None, clockMode: _user$project$Models$Start};

var _user$project$Messages$EditSecond = function (a) {
	return {ctor: 'EditSecond', _0: a};
};
var _user$project$Messages$EditMinute = function (a) {
	return {ctor: 'EditMinute', _0: a};
};
var _user$project$Messages$EditHour = function (a) {
	return {ctor: 'EditHour', _0: a};
};
var _user$project$Messages$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
var _user$project$Messages$CanvasClick = {ctor: 'CanvasClick'};
var _user$project$Messages$HandClick = function (a) {
	return {ctor: 'HandClick', _0: a};
};
var _user$project$Messages$StartTime = {ctor: 'StartTime'};
var _user$project$Messages$SetTime = function (a) {
	return {ctor: 'SetTime', _0: a};
};

var _user$project$View$visualEditor = function (_p0) {
	var _p1 = _p0;
	var _p6 = _p1.time;
	var _p5 = _p1.target;
	var secondHandColor = _elm_lang$core$Native_Utils.eq(_p5, _user$project$Models$SecondHand) ? '#ff9900' : '#2a2a2a';
	var minuteHandColor = _elm_lang$core$Native_Utils.eq(_p5, _user$project$Models$MinuteHand) ? '#ff9900' : '#2a2a2a';
	var hourHandColor = _elm_lang$core$Native_Utils.eq(_p5, _user$project$Models$HourHand) ? '#ff9900' : '#2a2a2a';
	...
	var handSecondX = _elm_lang$core$Basics$toString(
		50 + (35 * _elm_lang$core$Basics$sin((angleSecond * _elm_lang$core$Basics$pi) / 180)));
	var handSecondY = _elm_lang$core$Basics$toString(
		50 - (35 * _elm_lang$core$Basics$cos((angleSecond * _elm_lang$core$Basics$pi) / 180)));
	...
	var handMinuteX = _elm_lang$core$Basics$toString(
		50 + (35 * _elm_lang$core$Basics$sin((angleMinute * _elm_lang$core$Basics$pi) / 180)));
	var handMinuteY = _elm_lang$core$Basics$toString(
		50 - (35 * _elm_lang$core$Basics$cos((angleMinute * _elm_lang$core$Basics$pi) / 180)));
	var hourNow = _elm_lang$core$Date$hour(
		_elm_lang$core$Date$fromTime(_p6));
	var angleHour = _elm_lang$core$Basics$toFloat(30 * hourNow);
	var handHourX = _elm_lang$core$Basics$toString(
		50 + (35 * _elm_lang$core$Basics$sin((angleHour * _elm_lang$core$Basics$pi) / 180)));
	var handHourY = _elm_lang$core$Basics$toString(
		50 - (35 * _elm_lang$core$Basics$cos((angleHour * _elm_lang$core$Basics$pi) / 180)));
	return A2(
		_elm_lang$svg$Svg$svg,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Events$onClick(_user$project$Messages$CanvasClick),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 100 100'),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$class('visualEditor'),
					_1: {ctor: '[]'}
				}
			}
		},
						...
						_elm_lang$svg$Svg$line,
						{
							...
							_0: A3(
								...
								A2(
									_elm_lang$core$Json_Decode$map,
									function (_p2) {
										return _user$project$Messages$HandClick(_user$project$Models$HourHand);
									},
									_elm_lang$mouse$Mouse$position)),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$class('hand'),
								_1: {
									ctor: '::',
									...
									_1: {
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$stroke(hourHandColor),
													_1: {
														ctor: '::',
							...
							_elm_lang$svg$Svg$line,
							{
								...
								_0: A3(
									...
									A2(
										_elm_lang$core$Json_Decode$map,
										function (_p3) {
											return _user$project$Messages$HandClick(_user$project$Models$MinuteHand);
										},
										_elm_lang$mouse$Mouse$position)),
								_1: {
									ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$svg$Svg_Attributes$stroke(minuteHandColor),
														_1: {
															ctor: '::',
								...
								_elm_lang$svg$Svg$line,
								{
									...
									_0: A3(
										...
										A2(
											_elm_lang$core$Json_Decode$map,
											function (_p4) {
												return _user$project$Messages$HandClick(_user$project$Models$SecondHand);
											},
											_elm_lang$mouse$Mouse$position)),
									_1: {
										ctor: '::',
											...
											_1: {
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$svg$Svg_Attributes$stroke(secondHandColor),
															_1: {
																ctor: '::',
...
var _user$project$View$textEditor = function (_p7) {
	var _p8 = _p7;
	var _p10 = _p8.time;
	var _p9 = _p8.target;
	var secondStrColor = _elm_lang$core$Native_Utils.eq(_p9, _user$project$Models$SecondHand) ? '#ff9900' : '#2a2a2a';
	var minuteStrColor = _elm_lang$core$Native_Utils.eq(_p9, _user$project$Models$MinuteHand) ? '#ff9900' : '#2a2a2a';
	var hourStrColor = _elm_lang$core$Native_Utils.eq(_p9, _user$project$Models$HourHand) ? '#ff9900' : '#2a2a2a';
	var secondStr = A2(
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('textEditor'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$Messages$EditHour),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('time'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$value(hourStr),
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Attributes$style(
												{
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'color', _1: hourStrColor},
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Messages$EditMinute),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('time'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(minuteStr),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$type_('number'),
												_1: {
													...
													_0: _elm_lang$html$Html_Attributes$style(
														{
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'color', _1: minuteStrColor},
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Messages$EditSecond),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('time'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value(secondStr),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$type_('number'),
														_1: {
															...
															_0: _elm_lang$html$Html_Attributes$style(
																{
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'color', _1: secondStrColor},
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
...
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('hybridEditor'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$View$textEditor(model),
			_1: {
				ctor: '::',
				_0: _user$project$View$visualEditor(model),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Update$update = F2(
	function (msg, _p0) {
		...
		var _p5 = _p1.target;
		var _p4 = _p1;
		var oldSecond = _elm_lang$core$Time$second * _elm_lang$core$Basics$toFloat(
			_elm_lang$core$Date$second(
				_elm_lang$core$Date$fromTime(_p6)));
		var oldMinute = _elm_lang$core$Time$minute * _elm_lang$core$Basics$toFloat(
			_elm_lang$core$Date$minute(
				_elm_lang$core$Date$fromTime(_p6)));
		var oldHour = _elm_lang$core$Time$hour * _elm_lang$core$Basics$toFloat(
		...
		switch (_p2.ctor) {
			...
			case 'StartTime':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						_p4,
						{time: _p6 + _elm_lang$core$Time$second}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'EditHour':
				var hour = A2(
				...
				var newHour = ((_elm_lang$core$Native_Utils.cmp(hour, 0) < 0) || (_elm_lang$core$Native_Utils.cmp(hour, 24) > 0)) ? oldHour : (_elm_lang$core$Time$hour * hour);
				var newTime = (((_elm_lang$core$Time$hour * 15) + newHour) + oldMinute) + oldSecond;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						_p4,
			...
			case 'EditMinute':
				var minute = A2(
					...
					oldMinute,
					_elm_lang$core$String$toFloat(_p2._0));
				var newMinute = ((_elm_lang$core$Native_Utils.cmp(minute, 0) < 0) || (_elm_lang$core$Native_Utils.cmp(minute, 60) > 0)) ? oldHour : (_elm_lang$core$Time$minute * minute);
				var newTime = (((_elm_lang$core$Time$hour * 15) + oldHour) + newMinute) + oldSecond;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						_p4,
			...
			case 'EditSecond':
				var second = A2(
					...
					oldSecond,
					_elm_lang$core$String$toFloat(_p2._0));
				var newSecond = ((_elm_lang$core$Native_Utils.cmp(second, 0) < 0) || (_elm_lang$core$Native_Utils.cmp(second, 60) > 0)) ? oldHour : (_elm_lang$core$Time$second * second);
				var newTime = (((_elm_lang$core$Time$hour * 15) + oldHour) + oldMinute) + newSecond;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						_p4,
			...
			case 'CanvasClick':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						_p4,
						{target: _user$project$Models$None}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				var _p3 = _p2._0;
				if (_elm_lang$core$Native_Utils.eq(_p3, 32)) {
					var newClockMode = _elm_lang$core$Native_Utils.eq(_p1.clockMode, _user$project$Models$Start) ? _user$project$Models$Stop : _user$project$Models$Start;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							_p4,
							{target: _user$project$Models$None, clockMode: newClockMode}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var diffSecond = (_elm_lang$core$Native_Utils.eq(_p5, _user$project$Models$SecondHand) && _elm_lang$core$Native_Utils.eq(_p3, 39)) ? _elm_lang$core$Time$second : ((_elm_lang$core$Native_Utils.eq(_p5, _user$project$Models$SecondHand) && _elm_lang$core$Native_Utils.eq(_p3, 37)) ? _elm_lang$core$Basics$negate(_elm_lang$core$Time$second) : 0.0);
					var diffMinute = (_elm_lang$core$Native_Utils.eq(_p5, _user$project$Models$MinuteHand) && _elm_lang$core$Native_Utils.eq(_p3, 39)) ? _elm_lang$core$Time$minute : ((_elm_lang$core$Native_Utils.eq(_p5, _user$project$Models$MinuteHand) && _elm_lang$core$Native_Utils.eq(_p3, 37)) ? _elm_lang$core$Basics$negate(_elm_lang$core$Time$minute) : 0.0);
					var diffHour = (_elm_lang$core$Native_Utils.eq(_p5, _user$project$Models$HourHand) && _elm_lang$core$Native_Utils.eq(_p3, 39)) ? _elm_lang$core$Time$hour : ((_elm_lang$core$Native_Utils.eq(_p5, _user$project$Models$HourHand) && _elm_lang$core$Native_Utils.eq(_p3, 37)) ? _elm_lang$core$Basics$negate(_elm_lang$core$Time$hour) : 0.0);
					var diff = (diffHour + diffMinute) + diffSecond;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							_p4,
...
var _user$project$Main$subscriptions = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$core$Native_Utils.eq(_p1.clockMode, _user$project$Models$Start) ? _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(
				_elm_lang$core$Time$every,
				_elm_lang$core$Time$second,
				_elm_lang$core$Basics$always(_user$project$Messages$StartTime)),
			_1: {
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$downs(_user$project$Messages$KeyDown),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$now = A2(_elm_lang$core$Task$perform, _user$project$Messages$SetTime, _elm_lang$core$Time$now);
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Models$initialModel, _1: _user$project$Main$now};
var _user$project$Main$main = _elm_lang$html$Html$program(
	{init: _user$project$Main$init, view: _user$project$View$view, subscriptions: _user$project$Main$subscriptions, update: _user$project$Update$update})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Messages.Msg":{"args":[],"tags":{"EditSecond":["String"],"SetTime":["Time.Time"],"EditMinute":["String"],"StartTime":[],"HandClick":["Models.Target"],"CanvasClick":[],"EditHour":["String"],"KeyDown":["Keyboard.KeyCode"]}},"Models.Target":{"args":[],"tags":{"None":[],"HourHand":[],"MinuteHand":[],"SecondHand":[]}}},"aliases":{"Keyboard.KeyCode":{"args":[],"type":"Int"},"Time.Time":{"args":[],"type":"Float"}},"message":"Messages.Msg"},"versions":{"elm":"0.18.0"}});
}
